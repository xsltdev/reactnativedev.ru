...
Вы можете найти инструкции по оптимизации времени сборки и уменьшению влияния на вашу сборку на этой странице: [Speeding up your Build phase](build-speed.md).
