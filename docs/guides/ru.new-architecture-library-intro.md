...
Ниже приведен базовый шаблон спецификации JavaScript, написанный с использованием синтаксиса [Flow](https://flow.org/) и [TypeScript](https://www.typescriptlang.org/).
...
Следующий фрагмент показывает базовый шаблон спецификации JavaScript, написанный на [Flow](https://flow.org/), а также [TypeScript](https://www.typescriptlang.org/).
...
[Codegen] (the-new-architecture/pillars-codegen) - это инструмент, который запускается при сборке приложения для Android или установке зависимостей приложения для iOS. Он создает некоторый код, который вам не придется создавать вручную.
